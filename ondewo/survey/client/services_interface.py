...
"""Services base that injects the Keycloak bearer token into every SURVEY gRPC call.

The generated service wrappers (``ondewo/survey/client/services/*.py``) subclass
:class:`ServicesInterface` and forward :attr:`ServicesInterface.metadata` to every stub
call. When the :class:`~ondewo.survey.client.client_config.ClientConfig` opts into the D18
