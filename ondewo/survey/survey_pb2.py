...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SURVEYS'].methods_by_name['CreateSurvey']._loaded_options = None
  _globals['_SURVEYS'].methods_by_name['CreateSurvey']._serialized_options = b'\202\323\344\223\002\014\"\007/survey:\001*'
  _globals['_SURVEYS'].methods_by_name['GetSurvey']._loaded_options = None
  _globals['_SURVEYS'].methods_by_name['GetSurvey']._serialized_options = b'\202\323\344\223\002\027\022\025/survey/{survey_id=*}'
  _globals['_SURVEYS'].methods_by_name['UpdateSurvey']._loaded_options = None
  _globals['_SURVEYS'].methods_by_name['UpdateSurvey']._serialized_options = b'\202\323\344\223\002\0322\025/survey/{survey_id=*}:\001*'
  _globals['_SURVEYS'].methods_by_name['DeleteSurvey']._loaded_options = None
  _globals['_SURVEYS'].methods_by_name['DeleteSurvey']._serialized_options = b'\202\323\344\223\002\027*\025/survey/{survey_id=*}'
  _globals['_SURVEYS'].methods_by_name['ListSurveys']._loaded_options = None
  _globals['_SURVEYS'].methods_by_name['ListSurveys']._serialized_options = b'\202\323\344\223\002\n\022\010/surveys'
  _globals['_SURVEYS'].methods_by_name['GetSurveyAnswers']._loaded_options = None
  _globals['_SURVEYS'].methods_by_name['GetSurveyAnswers']._serialized_options = b'\202\323\344\223\002.\022,/survey/{survey_id=*}/answers/{session_id=*}'
  _globals['_SURVEYS'].methods_by_name['GetAllSurveyAnswers']._loaded_options = None
  _globals['_SURVEYS'].methods_by_name['GetAllSurveyAnswers']._serialized_options = b'\202\323\344\223\002\037\022\035/survey/{survey_id=*}/answers'
  _globals['_SURVEYS'].methods_by_name['CreateAgentSurvey']._loaded_options = None
  _globals['_SURVEYS'].methods_by_name['CreateAgentSurvey']._serialized_options = b'\202\323\344\223\002 \"\033/survey/{survey_id=*}/agent:\001*'
  _globals['_SURVEYS'].methods_by_name['UpdateAgentSurvey']._loaded_options = None
  _globals['_SURVEYS'].methods_by_name['UpdateAgentSurvey']._serialized_options = b'\202\323\344\223\002 2\033/survey/{survey_id=*}/agent:\001*'
  _globals['_SURVEYS'].methods_by_name['DeleteAgentSurvey']._loaded_options = None
  _globals['_SURVEYS'].methods_by_name['DeleteAgentSurvey']._serialized_options = b'\202\323\344\223\002$*\"/survey/{survey_id=*}/agent/delete'
