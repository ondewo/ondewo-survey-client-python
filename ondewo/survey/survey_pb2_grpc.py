...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in ondewo/survey/survey_pb2_grpc.py depends on'
...
def add_SurveysServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('ondewo.survey.Surveys', rpc_method_handlers)
